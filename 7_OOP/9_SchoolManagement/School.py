class School:
    ...
    def student_admission(self, student):
        ...
        if className in self.classrooms:
            # TODO: set student id, (roll num) at the time 
    ...
    def __repr__(self) -> str:
        ...
        for subject in eight.subjects:
            print(f'{subject.name} by {subject.teacher}')
        
        print('--------Student Exam Marks-------')
        for student in eight.students:
            for key, value in student.marks.items():
                print(f'{student.name} got {value} in {key}')
...
class Subject:
    ...
    def exam(self, students):
        for student in students:
            ...
            # student.marks = {self.name: self.teacher.evaluate_Exam()}
